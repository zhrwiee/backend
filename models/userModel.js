...
const userSchema = new mongoose.Schema({
    ...
    nric: { type: String, default: '000000000' },
    nationality: { type: String, default: 'Malaysia' },
    address: { type: Object, default: { line1: '', line2: '' ,postalCode:'',city:'',state:'',country: '' } },
...
// import sequelize from '../config/db.js'; // Make sure this path matches your setup
...
//   },
//   image: {
//     type: DataTypes.TEXT, // base64 strings can be long
//     defaultValue: 'data:image/png;base64,...', // Paste your default base64 string or manage via seed file
//   },
//   phone: {
//     type: DataTypes.STRING,
